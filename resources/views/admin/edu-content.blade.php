...
<head>
    ...
    <title>@yield('title', 'Cards Admin - Edu Content Management')</title>
        ...
        <div class="flex-1">
            ...
            <div class="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-xl font-semibold text-cards-teal">@yield('page-title', 'Cards Edu - Content Management')</h1>
                    <!-- Logout Button -->
